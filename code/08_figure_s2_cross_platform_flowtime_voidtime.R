...
build_figure_s2 <- function(root = find_project_root(), output_dir = NULL) {
  ...
  metric_specs <- list(
    list(parameter = "FlowTime", x_col = "Oneplus_FlowTime", y_col = "Redmi_FlowTime", unit = "s", point_color = "#B09C85FF", scatter_tag = "A", bland_tag = "B"),
    list(parameter = "VoidTime", x_col = "Oneplus_VoidTime", y_col = "Redmi_VoidTime", unit = "s", point_color = "#EE4C97FF", scatter_tag = "C", bland_tag = "D")
  )
  ...
  output_png <- file.path(output_dir, "FigureS2_cross_platform_flowtime_voidtime.png")
  ...
  panel_outputs <- save_panel_plot_outputs(
    panel_specs = list(
      list(plot_object = metric_panels[[1]]$scatter, panel_id = "A", file_stub = "flowtime_concordance", row = 1, col = 1),
      list(plot_object = metric_panels[[1]]$bland, panel_id = "B", file_stub = "flowtime_bland_altman", row = 1, col = 2),
      list(plot_object = metric_panels[[2]]$scatter, panel_id = "C", file_stub = "voidtime_concordance", row = 2, col = 1),
      list(plot_object = metric_panels[[2]]$bland, panel_id = "D", file_stub = "voidtime_bland_altman", row = 2, col = 2)
    ),
